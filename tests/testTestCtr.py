...
import PyGuide
import PyGuide.CentroidByShape
from PyGuide.CentroidByShape import centroid
import RO.DS9

PyGuide.CentroidByShape._CTRDEBUG = True
PyGuide.CentroidByShape._CTRITERDEBUG = True
# test data format:
...
for arrShape, ctr, sigma, ampl, scanRadFactor, maskLim in testData:
	...
	mask = None
	fwhm = sigma * PyGuide.FWHMPerSigma
	ctrData = centroid(data, mask, initGuess, scanRad, fwhm)
	measCtr = ctrData.ctr
